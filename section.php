...
<body class="hold-transition sidebar-mini layout-fixed">
                ...
                <div class="container">
                    <div class="card p-3">
                        <div class="print-button mb-3">
                            <button class="btn btn-primary" id="add-department" data-toggle="modal" data-target="#add_section">Add Course</button>
                        </div>
                        <div class="card p-3">
    ...
    <!-- add course modal -->
    <div class="modal fade" id="add_section" tabindex="-1" role="dialog" aria-labelledby="addDepartmentModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="section">
                        ...
                        <input type="text" class="form-control" id="section" placeholder="Enter course name">
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="Add_courses()">Add</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="section">
                        <label>section <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="update_section" placeholder="Enter course name">
                    </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="section_update()">Update</button>
